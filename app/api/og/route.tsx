...
export async function GET(req: NextRequest) {
  ...
  if (isSquare) {
    // ─── Square (500×500) — Light, liquid-glass ───
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              <img src={LOGO} width={52} height={52} style={{ objectFit: 'cover' }} />
            </div>
  ...
  // ─── OG Rectangle (1200×630) — Light, liquid-glass ───
  return new ImageResponse(
    (
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            <img src={LOGO} width={64} height={64} style={{ objectFit: 'cover' }} />
          </div>
